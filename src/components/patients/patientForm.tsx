...
import { PatientFormInput, PatientFormInputEdit } from "@/utils/validators/patientInput";
...
export default function PatientForm({
    ...
    handleSubmitForm?: (formData: PatientFormInput, id?: string) => Promise<boolean>,
    handleSubmitFormEdit?: (formData: PatientFormInputEdit, id: string, prefetchData: PatientData) => Promise<boolean>,
    patientId?: string,
    isEdit?: boolean
}) {
    const initialData = {
    ...
    const [prefetchData, setPrefetchData] = useState<PatientData>();
        ...
        if (isEdit) {
            const getData = async () => {
                try {
                    ...
                    const data: PatientData = result.data.patientData;
            ...
            {isLoading ?
                ...
                <form
                    onSubmit={async (evt) => {
                        ...
                        if (isEdit && patientId && prefetchData && handleSubmitFormEdit) {
