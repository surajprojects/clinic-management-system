        ...
        <>
            <ul className="text-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <li>
                    ...
                    <span className="mx-2 capitalize">{doctorData.user.fatherName === "" ? "N/A" : doctorData.user.fatherName}</span>
                </li>
                <li>
                    <span className="font-medium">Mother&apos;s Name:</span>
                    <span className="mx-2 capitalize">{doctorData.user.motherName === "" ? "N/A" : doctorData.user.motherName}</span>
                </li>
                <li>
                    <span className="font-medium">Date of Birth:</span>
                    <span className="mx-2">{doctorData.user.dob === "" ? "N/A" : formatDate(doctorData.user.dob.split("T")[0])}</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span className="mx-2">{doctorData.user.address === "" ? "N/A" : doctorData.user.address}</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span className="mx-2">{typeof doctorData.verified === "boolean" ? `${doctorData.verified}` : "N/A"}</span>
                </li>
            </ul >
        </>
    );
